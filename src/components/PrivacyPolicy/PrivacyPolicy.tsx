    ...
    return (
        <div className={styles.container}>
            ...
            <p>
                ...
                information as described in this Privacy Policy and, where required by applicable law, only where We
                have a valid legal basis to do so, including Your consent (where consent is required). This Privacy
            ...
            <h2>{t("pages.privacy.interpretationAndDefinitions")}</h2>
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to SoundGravity.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to SoundGravity, accessible from{" "}
                        <a href="https://sound-gravity-frontend.vercel.app/" rel="nofollow noreferrer" target="_blank">
                            https://sound-gravity-frontend.vercel.app/
                        </a>.
                    </p>
                </li>
                <li>
            ...
            <h2>{t("pages.privacy.collectingAndUsing")}</h2>
            ...
            <ul>
                ...
                <li>
                    ...
                    or inquired about. We send such marketing communications only where permitted by applicable law:
                    where prior consent is required (for example, under the laws applicable in the EEA and the UK), We
                    will send them only with Your consent; otherwise, We may send them until You opt out. You may opt
                    out or withdraw Your consent at any time by using the unsubscribe link in any marketing email We
            ...
            <ul>
                ...
                <li>
                    ...
                    to offer You certain products, services or promotions. Business partners may use this information
                    for their own purposes, as described in their own privacy policies.
                </li>
                <li>
            ...
            <p>
                ...
                other places where the parties involved in the processing are located. This means that this information
                may be transferred to — and maintained on — computers located outside of Your state, province, country
                or other governmental jurisdiction where the data protection laws may differ from those of Your
                jurisdiction.
            </p>
            <p>
                Where required by applicable law, We will ensure that international transfers of Your Personal Data
                are subject to appropriate safeguards and, where relevant, supplementary measures. The Company will
            ...
            <p>
                Under certain circumstances, the Company may disclose Your Personal Data if required to do so by law
            ...
            <h2>{t("pages.privacy.childrensPrivacy")}</h2>
            <p>
            ...
            <p>
                ...
                please contact Us. If We become aware that We have collected Personal Information from anyone under
                the age of 16, We will take steps to remove that information from Our servers as soon as reasonably
                possible.
            </p>
            <p>
                Some countries and states set a higher age at which an individual can consent to the processing of
                their own Personal Information. Where We rely on consent as a legal basis and the law applicable to a
                User sets an age higher than 16, We may require the consent of that User's parent or guardian before
                We collect and use their Personal Information.
            </p>

            <h2>{t("pages.privacy.linksToOtherWebsites")}</h2>
            <p>
            ...
            <h2>{t("pages.privacy.changesToPolicy")}</h2>
            <p>
            ...
            <h2>{t("pages.privacy.contactUs")}</h2>
            <p>If You have any questions about this Privacy Policy, You can contact Us:</p>
            <ul>
                <li>
                    By email: wouhnyua@gmail.com
                </li>
                <li>
